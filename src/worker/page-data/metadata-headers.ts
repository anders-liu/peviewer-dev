...
function generateCliHeader(pe: PEImage): W.SimpleStruct {
    ...
    s.items = [
        FM.formatU4Field("cb", h.cb),
        FM.formatU2Field("MajorRuntimeVersion", h.MajorRuntimeVersion),
        FM.formatU2Field("MinorRuntimeVersion", h.MinorRuntimeVersion),
        FM.formatU4Field("MetaData.VirtualAddress", h.MetaData.VirtualAddress),
        FM.formatU4Field("MetaData.Size", h.MetaData.Size),
...
function generateMetadataRoot(pe: PEImage): W.SimpleStruct | undefined {
    ...
    const s: W.SimpleStruct = {
        ...
        items: [
            ...
            FM.formatU2Field("MajorVersion", h.MajorVersion),
            FM.formatU2Field("MinorVersion", h.MinorVersion),
            FM.formatU4Field("Reserved", h.Reserved),
            FM.formatU4Field("VersionLength", h.VersionLength),
            ...
            FM.formatU2Field("Streams", h.Streams),
        ]
    };
    return s;
}
